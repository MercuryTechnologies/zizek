...
--
-- Both the verdict headline and the ledger's arrowhead\/elision\/footer text
-- compose their sentences exclusively from these fields plus /quoted/ user data.
...
-- | English language values for 'PhraseTable'.
english :: PhraseTable
english =
  PhraseTable
