...
-- dead lane @'@ could never be confused as they cannot share a column.
data Cell
  = -- Gutter (lane) cells
    NodeBorn
  | NodeTouch
...
-- ('Encoding.baseTransliterations') and this module's ledger cell glyphs.
