-- | A gallery of deliberately-failing stateful machines: the permanent
-- eyeball harness for the failure renderers. Four scenarios, each earning
-- its place:
--
--   1. stack palindrome — the smallest spliced report: a multi-rule '(===)'
--      failure with a structural diff in-band
--   2. warehouse — the realistic spliced report: four rules over three
...
-- * Scenario 3: file handles (citation ledger, flagship)
